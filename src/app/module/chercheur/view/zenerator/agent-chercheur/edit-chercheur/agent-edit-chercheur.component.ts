...
@Component({
  selector: 'app-agent-edit-chercheur',
  templateUrl: './agent-edit-chercheur.component.html',
  styleUrls: ['./agent-edit-chercheur.component.css']
})
export class AgentEditChercheurComponent implements OnInit {
