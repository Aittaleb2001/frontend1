...
@Component({
  selector: 'app-agent-view-chercheur',
  templateUrl: './agent-view-chercheur.component.html',
  styleUrls: ['./agent-view-chercheur.component.css']
})
export class AgentViewChercheurComponent implements OnInit {
