...
@Component({
  selector: 'app-quittance-prime-create-chercheur',
  templateUrl: './quittance-prime-create-chercheur.component.html',
  styleUrls: ['./quittance-prime-create-chercheur.component.css']
})
export class QuittancePrimeCreateChercheurComponent implements OnInit {
