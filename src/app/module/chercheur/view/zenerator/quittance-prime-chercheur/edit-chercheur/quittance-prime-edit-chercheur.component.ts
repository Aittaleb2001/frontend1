...
@Component({
  selector: 'app-quittance-prime-edit-chercheur',
  templateUrl: './quittance-prime-edit-chercheur.component.html',
  styleUrls: ['./quittance-prime-edit-chercheur.component.css']
})
export class QuittancePrimeEditChercheurComponent implements OnInit {
