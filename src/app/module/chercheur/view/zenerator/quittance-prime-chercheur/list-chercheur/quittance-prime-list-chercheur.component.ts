...
@Component({
  selector: 'app-quittance-prime-list-chercheur',
  templateUrl: './quittance-prime-list-chercheur.component.html',
  styleUrls: ['./quittance-prime-list-chercheur.component.css']
})
export class QuittancePrimeListChercheurComponent implements OnInit {
   // declarations
