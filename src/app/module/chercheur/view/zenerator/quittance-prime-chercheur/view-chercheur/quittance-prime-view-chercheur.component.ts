...
@Component({
  selector: 'app-quittance-prime-view-chercheur',
  templateUrl: './quittance-prime-view-chercheur.component.html',
  styleUrls: ['./quittance-prime-view-chercheur.component.css']
})
export class QuittancePrimeViewChercheurComponent implements OnInit {
