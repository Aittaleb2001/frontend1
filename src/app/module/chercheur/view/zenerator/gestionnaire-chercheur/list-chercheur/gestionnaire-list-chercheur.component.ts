...
@Component({
  selector: 'app-gestionnaire-list-chercheur',
  templateUrl: './gestionnaire-list-chercheur.component.html',
  styleUrls: ['./gestionnaire-list-chercheur.component.css']
})
export class GestionnaireListChercheurComponent implements OnInit {
   // declarations
