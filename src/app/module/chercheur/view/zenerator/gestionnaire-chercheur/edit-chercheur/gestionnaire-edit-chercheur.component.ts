...
@Component({
  selector: 'app-gestionnaire-edit-chercheur',
  templateUrl: './gestionnaire-edit-chercheur.component.html',
  styleUrls: ['./gestionnaire-edit-chercheur.component.css']
})
export class GestionnaireEditChercheurComponent implements OnInit {
