...
@Component({
  selector: 'app-type-vehicule-create-chercheur',
  templateUrl: './type-vehicule-create-chercheur.component.html',
  styleUrls: ['./type-vehicule-create-chercheur.component.css']
})
export class TypeVehiculeCreateChercheurComponent implements OnInit {
