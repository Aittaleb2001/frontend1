...
@Component({
  selector: 'app-contrat-garantie-create-chercheur',
  templateUrl: './contrat-garantie-create-chercheur.component.html',
  styleUrls: ['./contrat-garantie-create-chercheur.component.css']
})
export class ContratGarantieCreateChercheurComponent implements OnInit {
