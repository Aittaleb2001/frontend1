...
@Component({
  selector: 'app-contrat-garantie-list-chercheur',
  templateUrl: './contrat-garantie-list-chercheur.component.html',
  styleUrls: ['./contrat-garantie-list-chercheur.component.css']
})
export class ContratGarantieListChercheurComponent implements OnInit {
   // declarations
