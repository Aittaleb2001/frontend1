...
@Component({
  selector: 'app-contrat-garantie-view-chercheur',
  templateUrl: './contrat-garantie-view-chercheur.component.html',
  styleUrls: ['./contrat-garantie-view-chercheur.component.css']
})
export class ContratGarantieViewChercheurComponent implements OnInit {
