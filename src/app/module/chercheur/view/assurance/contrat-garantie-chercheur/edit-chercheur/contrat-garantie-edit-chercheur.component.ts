...
@Component({
  selector: 'app-contrat-garantie-edit-chercheur',
  templateUrl: './contrat-garantie-edit-chercheur.component.html',
  styleUrls: ['./contrat-garantie-edit-chercheur.component.css']
})
export class ContratGarantieEditChercheurComponent implements OnInit {
