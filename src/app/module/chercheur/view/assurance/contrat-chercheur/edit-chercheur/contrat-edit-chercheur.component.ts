...
@Component({
  selector: 'app-contrat-edit-chercheur',
  templateUrl: './contrat-edit-chercheur.component.html',
  styleUrls: ['./contrat-edit-chercheur.component.css']
})
export class ContratEditChercheurComponent implements OnInit {
