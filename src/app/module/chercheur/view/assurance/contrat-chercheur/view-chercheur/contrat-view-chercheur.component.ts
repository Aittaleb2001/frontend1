...
@Component({
  selector: 'app-contrat-view-chercheur',
  templateUrl: './contrat-view-chercheur.component.html',
  styleUrls: ['./contrat-view-chercheur.component.css']
})
export class ContratViewChercheurComponent implements OnInit {
