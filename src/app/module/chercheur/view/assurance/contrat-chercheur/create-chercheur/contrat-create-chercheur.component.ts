...
@Component({
  selector: 'app-contrat-create-chercheur',
  templateUrl: './contrat-create-chercheur.component.html',
  styleUrls: ['./contrat-create-chercheur.component.css']
})
export class ContratCreateChercheurComponent implements OnInit {
