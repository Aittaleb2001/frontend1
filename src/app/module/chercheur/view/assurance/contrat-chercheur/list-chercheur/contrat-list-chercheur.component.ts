...
@Component({
  selector: 'app-contrat-list-chercheur',
  templateUrl: './contrat-list-chercheur.component.html',
  styleUrls: ['./contrat-list-chercheur.component.css']
})
export class ContratListChercheurComponent implements OnInit {
   // declarations
