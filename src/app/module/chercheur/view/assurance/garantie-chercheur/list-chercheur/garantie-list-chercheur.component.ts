...
@Component({
  selector: 'app-garantie-list-chercheur',
  templateUrl: './garantie-list-chercheur.component.html',
  styleUrls: ['./garantie-list-chercheur.component.css']
})
export class GarantieListChercheurComponent implements OnInit {
   // declarations
