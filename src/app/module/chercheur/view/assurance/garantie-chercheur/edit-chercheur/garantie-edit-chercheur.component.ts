...
@Component({
  selector: 'app-garantie-edit-chercheur',
  templateUrl: './garantie-edit-chercheur.component.html',
  styleUrls: ['./garantie-edit-chercheur.component.css']
})
export class GarantieEditChercheurComponent implements OnInit {
