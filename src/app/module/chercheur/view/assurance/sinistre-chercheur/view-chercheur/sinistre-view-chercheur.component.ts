...
@Component({
  selector: 'app-sinistre-view-chercheur',
  templateUrl: './sinistre-view-chercheur.component.html',
  styleUrls: ['./sinistre-view-chercheur.component.css']
})
export class SinistreViewChercheurComponent implements OnInit {
