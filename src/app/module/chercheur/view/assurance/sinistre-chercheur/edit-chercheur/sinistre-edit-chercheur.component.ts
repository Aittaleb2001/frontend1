...
@Component({
  selector: 'app-sinistre-edit-chercheur',
  templateUrl: './sinistre-edit-chercheur.component.html',
  styleUrls: ['./sinistre-edit-chercheur.component.css']
})
export class SinistreEditChercheurComponent implements OnInit {
