...
@Component({
  selector: 'app-sinistre-list-chercheur',
  templateUrl: './sinistre-list-chercheur.component.html',
  styleUrls: ['./sinistre-list-chercheur.component.css']
})
export class SinistreListChercheurComponent implements OnInit {
   // declarations
