...
@Component({
  selector: 'app-vehicule-edit-chercheur',
  templateUrl: './vehicule-edit-chercheur.component.html',
  styleUrls: ['./vehicule-edit-chercheur.component.css']
})
export class VehiculeEditChercheurComponent implements OnInit {
