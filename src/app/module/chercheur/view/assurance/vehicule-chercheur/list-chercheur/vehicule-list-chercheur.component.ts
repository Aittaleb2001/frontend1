...
@Component({
  selector: 'app-vehicule-list-chercheur',
  templateUrl: './vehicule-list-chercheur.component.html',
  styleUrls: ['./vehicule-list-chercheur.component.css']
})
export class VehiculeListChercheurComponent implements OnInit {
   // declarations
