...
@Component({
  selector: 'app-quittance-indemniser-list-chercheur',
  templateUrl: './quittance-indemniser-list-chercheur.component.html',
  styleUrls: ['./quittance-indemniser-list-chercheur.component.css']
})
export class QuittanceIndemniserListChercheurComponent implements OnInit {
   // declarations
