...
@Component({
  selector: 'app-quittance-indemniser-view-chercheur',
  templateUrl: './quittance-indemniser-view-chercheur.component.html',
  styleUrls: ['./quittance-indemniser-view-chercheur.component.css']
})
export class QuittanceIndemniserViewChercheurComponent implements OnInit {
