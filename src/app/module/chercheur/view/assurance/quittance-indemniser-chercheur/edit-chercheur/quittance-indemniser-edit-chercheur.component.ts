...
@Component({
  selector: 'app-quittance-indemniser-edit-chercheur',
  templateUrl: './quittance-indemniser-edit-chercheur.component.html',
  styleUrls: ['./quittance-indemniser-edit-chercheur.component.css']
})
export class QuittanceIndemniserEditChercheurComponent implements OnInit {
