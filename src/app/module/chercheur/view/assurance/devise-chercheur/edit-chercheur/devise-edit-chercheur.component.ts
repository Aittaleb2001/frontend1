...
@Component({
  selector: 'app-devise-edit-chercheur',
  templateUrl: './devise-edit-chercheur.component.html',
  styleUrls: ['./devise-edit-chercheur.component.css']
})
export class DeviseEditChercheurComponent implements OnInit {
