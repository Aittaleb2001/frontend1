...
@Component({
  selector: 'app-devise-create-chercheur',
  templateUrl: './devise-create-chercheur.component.html',
  styleUrls: ['./devise-create-chercheur.component.css']
})
export class DeviseCreateChercheurComponent implements OnInit {
