...
@Component({
  selector: 'app-devise-list-chercheur',
  templateUrl: './devise-list-chercheur.component.html',
  styleUrls: ['./devise-list-chercheur.component.css']
})
export class DeviseListChercheurComponent implements OnInit {
   // declarations
