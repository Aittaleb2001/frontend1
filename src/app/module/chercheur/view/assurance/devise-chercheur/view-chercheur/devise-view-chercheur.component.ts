...
@Component({
  selector: 'app-devise-view-chercheur',
  templateUrl: './devise-view-chercheur.component.html',
  styleUrls: ['./devise-view-chercheur.component.css']
})
export class DeviseViewChercheurComponent implements OnInit {
