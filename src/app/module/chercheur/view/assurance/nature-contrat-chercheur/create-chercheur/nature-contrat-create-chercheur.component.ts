...
@Component({
  selector: 'app-nature-contrat-create-chercheur',
  templateUrl: './nature-contrat-create-chercheur.component.html',
  styleUrls: ['./nature-contrat-create-chercheur.component.css']
})
export class NatureContratCreateChercheurComponent implements OnInit {
