...
@Component({
  selector: 'app-nature-contrat-edit-chercheur',
  templateUrl: './nature-contrat-edit-chercheur.component.html',
  styleUrls: ['./nature-contrat-edit-chercheur.component.css']
})
export class NatureContratEditChercheurComponent implements OnInit {
