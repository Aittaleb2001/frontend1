...
@Component({
  selector: 'app-nature-contrat-view-chercheur',
  templateUrl: './nature-contrat-view-chercheur.component.html',
  styleUrls: ['./nature-contrat-view-chercheur.component.css']
})
export class NatureContratViewChercheurComponent implements OnInit {
