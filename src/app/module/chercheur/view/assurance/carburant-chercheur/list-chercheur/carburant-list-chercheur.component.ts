...
@Component({
  selector: 'app-carburant-list-chercheur',
  templateUrl: './carburant-list-chercheur.component.html',
  styleUrls: ['./carburant-list-chercheur.component.css']
})
export class CarburantListChercheurComponent implements OnInit {
   // declarations
