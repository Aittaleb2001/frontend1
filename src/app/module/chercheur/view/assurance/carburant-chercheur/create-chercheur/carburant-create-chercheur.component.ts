...
@Component({
  selector: 'app-carburant-create-chercheur',
  templateUrl: './carburant-create-chercheur.component.html',
  styleUrls: ['./carburant-create-chercheur.component.css']
})
export class CarburantCreateChercheurComponent implements OnInit {
