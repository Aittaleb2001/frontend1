...
@Component({
  selector: 'app-carburant-edit-chercheur',
  templateUrl: './carburant-edit-chercheur.component.html',
  styleUrls: ['./carburant-edit-chercheur.component.css']
})
export class CarburantEditChercheurComponent implements OnInit {
