...
@Component({
  selector: 'app-type-sinistre-list-chercheur',
  templateUrl: './type-sinistre-list-chercheur.component.html',
  styleUrls: ['./type-sinistre-list-chercheur.component.css']
})
export class TypeSinistreListChercheurComponent implements OnInit {
   // declarations
