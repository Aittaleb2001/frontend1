...
@Component({
  selector: 'app-type-sinistre-create-chercheur',
  templateUrl: './type-sinistre-create-chercheur.component.html',
  styleUrls: ['./type-sinistre-create-chercheur.component.css']
})
export class TypeSinistreCreateChercheurComponent implements OnInit {
