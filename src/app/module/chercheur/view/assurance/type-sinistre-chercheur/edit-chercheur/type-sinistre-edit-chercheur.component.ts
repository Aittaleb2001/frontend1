...
@Component({
  selector: 'app-type-sinistre-edit-chercheur',
  templateUrl: './type-sinistre-edit-chercheur.component.html',
  styleUrls: ['./type-sinistre-edit-chercheur.component.css']
})
export class TypeSinistreEditChercheurComponent implements OnInit {
