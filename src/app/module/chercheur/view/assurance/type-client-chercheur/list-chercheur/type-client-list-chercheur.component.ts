...
@Component({
  selector: 'app-type-client-list-chercheur',
  templateUrl: './type-client-list-chercheur.component.html',
  styleUrls: ['./type-client-list-chercheur.component.css']
})
export class TypeClientListChercheurComponent implements OnInit {
   // declarations
