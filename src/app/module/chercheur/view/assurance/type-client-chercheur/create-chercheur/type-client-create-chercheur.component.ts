...
@Component({
  selector: 'app-type-client-create-chercheur',
  templateUrl: './type-client-create-chercheur.component.html',
  styleUrls: ['./type-client-create-chercheur.component.css']
})
export class TypeClientCreateChercheurComponent implements OnInit {
