...
@Component({
  selector: 'app-marque-list-chercheur',
  templateUrl: './marque-list-chercheur.component.html',
  styleUrls: ['./marque-list-chercheur.component.css']
})
export class MarqueListChercheurComponent implements OnInit {
   // declarations
