...
@Component({
  selector: 'app-client-sininstre-edit-chercheur',
  templateUrl: './client-sininstre-edit-chercheur.component.html',
  styleUrls: ['./client-sininstre-edit-chercheur.component.css']
})
export class ClientSininstreEditChercheurComponent implements OnInit {
