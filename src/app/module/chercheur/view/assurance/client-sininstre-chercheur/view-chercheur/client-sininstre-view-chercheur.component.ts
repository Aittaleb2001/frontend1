...
@Component({
  selector: 'app-client-sininstre-view-chercheur',
  templateUrl: './client-sininstre-view-chercheur.component.html',
  styleUrls: ['./client-sininstre-view-chercheur.component.css']
})
export class ClientSininstreViewChercheurComponent implements OnInit {
