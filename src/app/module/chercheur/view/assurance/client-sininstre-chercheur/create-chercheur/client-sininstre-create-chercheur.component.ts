...
@Component({
  selector: 'app-client-sininstre-create-chercheur',
  templateUrl: './client-sininstre-create-chercheur.component.html',
  styleUrls: ['./client-sininstre-create-chercheur.component.css']
})
export class ClientSininstreCreateChercheurComponent implements OnInit {
