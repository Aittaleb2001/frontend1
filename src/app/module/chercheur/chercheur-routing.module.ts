            ...
            [
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            path: 'assurance',
                            loadChildren: './view/assurance/assurance-chercheur-routing.module#AssuranceChercheurRoutingModule',
                            canActivate: [AuthGuard],
                        },
                        {

                            path: 'zenerator',
                            loadChildren: './view/zenerator/zenerator-chercheur-routing.module#ZeneratorChercheurRoutingModule',
                            canActivate: [AuthGuard],
                        },
                    ]
                },
