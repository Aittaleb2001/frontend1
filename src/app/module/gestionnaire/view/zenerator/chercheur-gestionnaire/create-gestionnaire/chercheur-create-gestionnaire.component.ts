...
@Component({
  selector: 'app-chercheur-create-gestionnaire',
  templateUrl: './chercheur-create-gestionnaire.component.html',
  styleUrls: ['./chercheur-create-gestionnaire.component.css']
})
export class ChercheurCreateGestionnaireComponent implements OnInit {
