...
@Component({
  selector: 'app-chercheur-view-gestionnaire',
  templateUrl: './chercheur-view-gestionnaire.component.html',
  styleUrls: ['./chercheur-view-gestionnaire.component.css']
})
export class ChercheurViewGestionnaireComponent implements OnInit {
