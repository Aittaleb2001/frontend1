...
@Component({
  selector: 'app-chercheur-list-gestionnaire',
  templateUrl: './chercheur-list-gestionnaire.component.html',
  styleUrls: ['./chercheur-list-gestionnaire.component.css']
})
export class ChercheurListGestionnaireComponent implements OnInit {
   // declarations
  ...
  initExport() : void {
    ...
    return {
      ...
      this.criteriaData = [{
          ...
          //  'Formation en management': this.searchChercheur.formationEnManagement ? this.searchChercheur.formationEnManagement : environment.emptyForExport ,
