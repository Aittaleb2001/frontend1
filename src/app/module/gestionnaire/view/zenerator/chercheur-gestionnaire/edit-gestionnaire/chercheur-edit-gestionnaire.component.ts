...
@Component({
  selector: 'app-chercheur-edit-gestionnaire',
  templateUrl: './chercheur-edit-gestionnaire.component.html',
  styleUrls: ['./chercheur-edit-gestionnaire.component.css']
})
export class ChercheurEditGestionnaireComponent implements OnInit {
