...
@Component({
  selector: 'app-agent-list-gestionnaire',
  templateUrl: './agent-list-gestionnaire.component.html',
  styleUrls: ['./agent-list-gestionnaire.component.css']
})
export class AgentListGestionnaireComponent implements OnInit {
   // declarations
