...
@Component({
  selector: 'app-agent-view-gestionnaire',
  templateUrl: './agent-view-gestionnaire.component.html',
  styleUrls: ['./agent-view-gestionnaire.component.css']
})
export class AgentViewGestionnaireComponent implements OnInit {
