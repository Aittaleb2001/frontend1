...
@Component({
  selector: 'app-gestionnaire-edit-gestionnaire',
  templateUrl: './gestionnaire-edit-gestionnaire.component.html',
  styleUrls: ['./gestionnaire-edit-gestionnaire.component.css']
})
export class GestionnaireEditGestionnaireComponent implements OnInit {
