...
@Component({
  selector: 'app-gestionnaire-list-gestionnaire',
  templateUrl: './gestionnaire-list-gestionnaire.component.html',
  styleUrls: ['./gestionnaire-list-gestionnaire.component.css']
})
export class GestionnaireListGestionnaireComponent implements OnInit {
   // declarations
