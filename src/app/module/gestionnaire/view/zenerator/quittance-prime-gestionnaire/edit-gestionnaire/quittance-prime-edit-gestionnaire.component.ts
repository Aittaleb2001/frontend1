...
@Component({
  selector: 'app-quittance-prime-edit-gestionnaire',
  templateUrl: './quittance-prime-edit-gestionnaire.component.html',
  styleUrls: ['./quittance-prime-edit-gestionnaire.component.css']
})
export class QuittancePrimeEditGestionnaireComponent implements OnInit {
