...
@Component({
  selector: 'app-quittance-prime-list-gestionnaire',
  templateUrl: './quittance-prime-list-gestionnaire.component.html',
  styleUrls: ['./quittance-prime-list-gestionnaire.component.css']
})
export class QuittancePrimeListGestionnaireComponent implements OnInit {
   // declarations
