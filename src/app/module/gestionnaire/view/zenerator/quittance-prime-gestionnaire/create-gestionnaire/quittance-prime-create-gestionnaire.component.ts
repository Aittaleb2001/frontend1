...
@Component({
  selector: 'app-quittance-prime-create-gestionnaire',
  templateUrl: './quittance-prime-create-gestionnaire.component.html',
  styleUrls: ['./quittance-prime-create-gestionnaire.component.css']
})
export class QuittancePrimeCreateGestionnaireComponent implements OnInit {
...
public saveWithShowOption(showList: boolean){
     this.quittancePrimeService.save().subscribe(quittancePrime=>{
       this.quittancePrimes.push({...quittancePrime});
       this.createQuittancePrimeDialog = false;
