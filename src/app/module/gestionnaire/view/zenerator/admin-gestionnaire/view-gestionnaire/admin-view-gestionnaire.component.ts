...
@Component({
  selector: 'app-admin-view-gestionnaire',
  templateUrl: './admin-view-gestionnaire.component.html',
  styleUrls: ['./admin-view-gestionnaire.component.css']
})
export class AdminViewGestionnaireComponent implements OnInit {
