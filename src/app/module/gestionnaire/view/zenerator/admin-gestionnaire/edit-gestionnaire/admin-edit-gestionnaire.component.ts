...
@Component({
  selector: 'app-admin-edit-gestionnaire',
  templateUrl: './admin-edit-gestionnaire.component.html',
  styleUrls: ['./admin-edit-gestionnaire.component.css']
})
export class AdminEditGestionnaireComponent implements OnInit {
