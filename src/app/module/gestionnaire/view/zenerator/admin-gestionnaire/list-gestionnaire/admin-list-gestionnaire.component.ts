...
@Component({
  selector: 'app-admin-list-gestionnaire',
  templateUrl: './admin-list-gestionnaire.component.html',
  styleUrls: ['./admin-list-gestionnaire.component.css']
})
export class AdminListGestionnaireComponent implements OnInit {
   // declarations
