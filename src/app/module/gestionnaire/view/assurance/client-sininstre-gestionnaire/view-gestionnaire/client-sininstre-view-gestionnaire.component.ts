...
@Component({
  selector: 'app-client-sininstre-view-gestionnaire',
  templateUrl: './client-sininstre-view-gestionnaire.component.html',
  styleUrls: ['./client-sininstre-view-gestionnaire.component.css']
})
export class ClientSininstreViewGestionnaireComponent implements OnInit {
