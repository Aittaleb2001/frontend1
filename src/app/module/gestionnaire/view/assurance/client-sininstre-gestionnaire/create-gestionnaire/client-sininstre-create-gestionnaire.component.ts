...
@Component({
  selector: 'app-client-sininstre-create-gestionnaire',
  templateUrl: './client-sininstre-create-gestionnaire.component.html',
  styleUrls: ['./client-sininstre-create-gestionnaire.component.css']
})
export class ClientSininstreCreateGestionnaireComponent implements OnInit {
...
public saveWithShowOption(showList: boolean){
     this.clientSininstreService.save().subscribe(clientSininstre=>{
       this.clientSininstres.push({...clientSininstre});
       this.createClientSininstreDialog = false;
