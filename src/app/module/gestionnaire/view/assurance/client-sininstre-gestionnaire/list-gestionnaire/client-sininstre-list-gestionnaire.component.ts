...
@Component({
  selector: 'app-client-sininstre-list-gestionnaire',
  templateUrl: './client-sininstre-list-gestionnaire.component.html',
  styleUrls: ['./client-sininstre-list-gestionnaire.component.css']
})
export class ClientSininstreListGestionnaireComponent implements OnInit {
   // declarations
