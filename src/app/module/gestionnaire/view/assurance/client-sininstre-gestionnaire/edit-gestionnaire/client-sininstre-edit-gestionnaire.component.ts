...
@Component({
  selector: 'app-client-sininstre-edit-gestionnaire',
  templateUrl: './client-sininstre-edit-gestionnaire.component.html',
  styleUrls: ['./client-sininstre-edit-gestionnaire.component.css']
})
export class ClientSininstreEditGestionnaireComponent implements OnInit {
