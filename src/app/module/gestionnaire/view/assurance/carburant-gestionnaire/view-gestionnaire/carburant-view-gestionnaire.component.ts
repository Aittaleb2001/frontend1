...
@Component({
  selector: 'app-carburant-view-gestionnaire',
  templateUrl: './carburant-view-gestionnaire.component.html',
  styleUrls: ['./carburant-view-gestionnaire.component.css']
})
export class CarburantViewGestionnaireComponent implements OnInit {
