...
@Component({
  selector: 'app-carburant-edit-gestionnaire',
  templateUrl: './carburant-edit-gestionnaire.component.html',
  styleUrls: ['./carburant-edit-gestionnaire.component.css']
})
export class CarburantEditGestionnaireComponent implements OnInit {
