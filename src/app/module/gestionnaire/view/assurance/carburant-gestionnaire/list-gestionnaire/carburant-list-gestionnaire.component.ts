...
@Component({
  selector: 'app-carburant-list-gestionnaire',
  templateUrl: './carburant-list-gestionnaire.component.html',
  styleUrls: ['./carburant-list-gestionnaire.component.css']
})
export class CarburantListGestionnaireComponent implements OnInit {
   // declarations
