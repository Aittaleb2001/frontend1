...
@Component({
  selector: 'app-contrat-garantie-view-gestionnaire',
  templateUrl: './contrat-garantie-view-gestionnaire.component.html',
  styleUrls: ['./contrat-garantie-view-gestionnaire.component.css']
})
export class ContratGarantieViewGestionnaireComponent implements OnInit {
