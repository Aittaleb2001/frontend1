...
@Component({
  selector: 'app-nature-contrat-edit-gestionnaire',
  templateUrl: './nature-contrat-edit-gestionnaire.component.html',
  styleUrls: ['./nature-contrat-edit-gestionnaire.component.css']
})
export class NatureContratEditGestionnaireComponent implements OnInit {
