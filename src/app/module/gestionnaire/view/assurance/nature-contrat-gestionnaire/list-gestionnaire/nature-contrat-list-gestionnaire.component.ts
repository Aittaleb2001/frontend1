...
@Component({
  selector: 'app-nature-contrat-list-gestionnaire',
  templateUrl: './nature-contrat-list-gestionnaire.component.html',
  styleUrls: ['./nature-contrat-list-gestionnaire.component.css']
})
export class NatureContratListGestionnaireComponent implements OnInit {
   // declarations
