...
@Component({
  selector: 'app-nature-contrat-view-gestionnaire',
  templateUrl: './nature-contrat-view-gestionnaire.component.html',
  styleUrls: ['./nature-contrat-view-gestionnaire.component.css']
})
export class NatureContratViewGestionnaireComponent implements OnInit {
