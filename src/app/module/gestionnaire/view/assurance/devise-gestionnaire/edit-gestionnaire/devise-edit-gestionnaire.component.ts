...
@Component({
  selector: 'app-devise-edit-gestionnaire',
  templateUrl: './devise-edit-gestionnaire.component.html',
  styleUrls: ['./devise-edit-gestionnaire.component.css']
})
export class DeviseEditGestionnaireComponent implements OnInit {
