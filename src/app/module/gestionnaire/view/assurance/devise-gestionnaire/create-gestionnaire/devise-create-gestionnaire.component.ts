...
@Component({
  selector: 'app-devise-create-gestionnaire',
  templateUrl: './devise-create-gestionnaire.component.html',
  styleUrls: ['./devise-create-gestionnaire.component.css']
})
export class DeviseCreateGestionnaireComponent implements OnInit {
