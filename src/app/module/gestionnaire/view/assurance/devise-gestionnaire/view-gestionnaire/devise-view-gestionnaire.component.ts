...
@Component({
  selector: 'app-devise-view-gestionnaire',
  templateUrl: './devise-view-gestionnaire.component.html',
  styleUrls: ['./devise-view-gestionnaire.component.css']
})
export class DeviseViewGestionnaireComponent implements OnInit {
