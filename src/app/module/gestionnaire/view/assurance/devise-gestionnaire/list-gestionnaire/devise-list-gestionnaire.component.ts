...
@Component({
  selector: 'app-devise-list-gestionnaire',
  templateUrl: './devise-list-gestionnaire.component.html',
  styleUrls: ['./devise-list-gestionnaire.component.css']
})
export class DeviseListGestionnaireComponent implements OnInit {
   // declarations
