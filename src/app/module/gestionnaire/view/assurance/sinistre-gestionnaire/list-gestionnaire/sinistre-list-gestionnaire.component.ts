...
@Component({
  selector: 'app-sinistre-list-gestionnaire',
  templateUrl: './sinistre-list-gestionnaire.component.html',
  styleUrls: ['./sinistre-list-gestionnaire.component.css']
})
export class SinistreListGestionnaireComponent implements OnInit {
   // declarations
