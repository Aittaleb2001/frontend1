...
@Component({
  selector: 'app-sinistre-create-gestionnaire',
  templateUrl: './sinistre-create-gestionnaire.component.html',
  styleUrls: ['./sinistre-create-gestionnaire.component.css']
})
export class SinistreCreateGestionnaireComponent implements OnInit {
