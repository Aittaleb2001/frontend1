...
@Component({
  selector: 'app-sinistre-edit-gestionnaire',
  templateUrl: './sinistre-edit-gestionnaire.component.html',
  styleUrls: ['./sinistre-edit-gestionnaire.component.css']
})
export class SinistreEditGestionnaireComponent implements OnInit {
