...
@Component({
  selector: 'app-sinistre-view-gestionnaire',
  templateUrl: './sinistre-view-gestionnaire.component.html',
  styleUrls: ['./sinistre-view-gestionnaire.component.css']
})
export class SinistreViewGestionnaireComponent implements OnInit {
