...
@Component({
  selector: 'app-vehicule-create-gestionnaire',
  templateUrl: './vehicule-create-gestionnaire.component.html',
  styleUrls: ['./vehicule-create-gestionnaire.component.css']
})
export class VehiculeCreateGestionnaireComponent implements OnInit {
