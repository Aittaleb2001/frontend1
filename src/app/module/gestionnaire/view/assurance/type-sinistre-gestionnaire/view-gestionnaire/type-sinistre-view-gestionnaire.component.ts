...
@Component({
  selector: 'app-type-sinistre-view-gestionnaire',
  templateUrl: './type-sinistre-view-gestionnaire.component.html',
  styleUrls: ['./type-sinistre-view-gestionnaire.component.css']
})
export class TypeSinistreViewGestionnaireComponent implements OnInit {
