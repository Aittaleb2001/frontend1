...
@Component({
  selector: 'app-type-sinistre-edit-gestionnaire',
  templateUrl: './type-sinistre-edit-gestionnaire.component.html',
  styleUrls: ['./type-sinistre-edit-gestionnaire.component.css']
})
export class TypeSinistreEditGestionnaireComponent implements OnInit {
