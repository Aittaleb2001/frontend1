...
@Component({
  selector: 'app-type-sinistre-create-gestionnaire',
  templateUrl: './type-sinistre-create-gestionnaire.component.html',
  styleUrls: ['./type-sinistre-create-gestionnaire.component.css']
})
export class TypeSinistreCreateGestionnaireComponent implements OnInit {
