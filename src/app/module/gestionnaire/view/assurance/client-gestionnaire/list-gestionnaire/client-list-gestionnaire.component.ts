...
@Component({
  selector: 'app-client-list-gestionnaire',
  templateUrl: './client-list-gestionnaire.component.html',
  styleUrls: ['./client-list-gestionnaire.component.css']
})
export class ClientListGestionnaireComponent implements OnInit {
   // declarations
