...
@Component({
  selector: 'app-client-create-gestionnaire',
  templateUrl: './client-create-gestionnaire.component.html',
  styleUrls: ['./client-create-gestionnaire.component.css']
})
export class ClientCreateGestionnaireComponent implements OnInit {
