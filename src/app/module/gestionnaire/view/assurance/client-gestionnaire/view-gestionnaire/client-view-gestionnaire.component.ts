...
@Component({
  selector: 'app-client-view-gestionnaire',
  templateUrl: './client-view-gestionnaire.component.html',
  styleUrls: ['./client-view-gestionnaire.component.css']
})
export class ClientViewGestionnaireComponent implements OnInit {
