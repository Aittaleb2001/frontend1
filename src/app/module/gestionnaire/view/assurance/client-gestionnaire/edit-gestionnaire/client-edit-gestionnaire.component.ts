...
@Component({
  selector: 'app-client-edit-gestionnaire',
  templateUrl: './client-edit-gestionnaire.component.html',
  styleUrls: ['./client-edit-gestionnaire.component.css']
})
export class ClientEditGestionnaireComponent implements OnInit {
   ...
   _validClientContrat = true;
    ...
    _validClientSininstresRef = true;
    _validClientSininstresDateSinistre = true;
    _validClientSininstresMontantExpertise = true;
    _validClientSininstresMontantIndemniser = true;
    _validClientSininstresObservation = true;
    _validClientSininstresClient = true;
    _validClientSininstresSinistre = true;
    _validClientSininstresQuittanceIndemniser = true;
