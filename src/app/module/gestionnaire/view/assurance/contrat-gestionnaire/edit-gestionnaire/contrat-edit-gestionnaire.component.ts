...
@Component({
  selector: 'app-contrat-edit-gestionnaire',
  templateUrl: './contrat-edit-gestionnaire.component.html',
  styleUrls: ['./contrat-edit-gestionnaire.component.css']
})
export class ContratEditGestionnaireComponent implements OnInit {
