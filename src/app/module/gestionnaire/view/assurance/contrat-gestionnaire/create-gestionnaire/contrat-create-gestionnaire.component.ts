...
@Component({
  selector: 'app-contrat-create-gestionnaire',
  templateUrl: './contrat-create-gestionnaire.component.html',
  styleUrls: ['./contrat-create-gestionnaire.component.css']
})
export class ContratCreateGestionnaireComponent implements OnInit {
...
public saveWithShowOption(showList: boolean){
     this.contratService.save().subscribe(contrat=>{
       this.contrats.push({...contrat});
       this.createContratDialog = false;
