...
@Component({
  selector: 'app-contrat-list-gestionnaire',
  templateUrl: './contrat-list-gestionnaire.component.html',
  styleUrls: ['./contrat-list-gestionnaire.component.css']
})
export class ContratListGestionnaireComponent implements OnInit {
   // declarations
