...
@Component({
  selector: 'app-contrat-view-gestionnaire',
  templateUrl: './contrat-view-gestionnaire.component.html',
  styleUrls: ['./contrat-view-gestionnaire.component.css']
})
export class ContratViewGestionnaireComponent implements OnInit {
