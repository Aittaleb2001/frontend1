...
@Component({
  selector: 'app-type-vehicule-view-gestionnaire',
  templateUrl: './type-vehicule-view-gestionnaire.component.html',
  styleUrls: ['./type-vehicule-view-gestionnaire.component.css']
})
export class TypeVehiculeViewGestionnaireComponent implements OnInit {
