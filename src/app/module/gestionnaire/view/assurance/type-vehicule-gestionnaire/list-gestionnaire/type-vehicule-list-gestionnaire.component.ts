...
@Component({
  selector: 'app-type-vehicule-list-gestionnaire',
  templateUrl: './type-vehicule-list-gestionnaire.component.html',
  styleUrls: ['./type-vehicule-list-gestionnaire.component.css']
})
export class TypeVehiculeListGestionnaireComponent implements OnInit {
   // declarations
...
public async duplicateTypeVehicule(typeVehicule: TypeVehiculeVo) {
  ...
  initExport() : void {
    ...
    return {
      ...
      this.criteriaData = [{
            'Libelle': this.searchTypeVehicule.libelle ? this.searchTypeVehicule.libelle : environment.emptyForExport ,
     }];
