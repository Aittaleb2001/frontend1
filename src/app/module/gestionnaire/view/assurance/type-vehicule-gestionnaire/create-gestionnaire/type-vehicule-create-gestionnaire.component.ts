...
@Component({
  selector: 'app-type-vehicule-create-gestionnaire',
  templateUrl: './type-vehicule-create-gestionnaire.component.html',
  styleUrls: ['./type-vehicule-create-gestionnaire.component.css']
})
export class TypeVehiculeCreateGestionnaireComponent implements OnInit {
