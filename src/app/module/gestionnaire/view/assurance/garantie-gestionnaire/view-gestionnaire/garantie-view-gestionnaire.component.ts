...
@Component({
  selector: 'app-garantie-view-gestionnaire',
  templateUrl: './garantie-view-gestionnaire.component.html',
  styleUrls: ['./garantie-view-gestionnaire.component.css']
})
export class GarantieViewGestionnaireComponent implements OnInit {
