...
@Component({
  selector: 'app-garantie-list-gestionnaire',
  templateUrl: './garantie-list-gestionnaire.component.html',
  styleUrls: ['./garantie-list-gestionnaire.component.css']
})
export class GarantieListGestionnaireComponent implements OnInit {
   // declarations
