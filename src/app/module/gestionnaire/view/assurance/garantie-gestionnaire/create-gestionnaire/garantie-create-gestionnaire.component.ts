...
@Component({
  selector: 'app-garantie-create-gestionnaire',
  templateUrl: './garantie-create-gestionnaire.component.html',
  styleUrls: ['./garantie-create-gestionnaire.component.css']
})
export class GarantieCreateGestionnaireComponent implements OnInit {
