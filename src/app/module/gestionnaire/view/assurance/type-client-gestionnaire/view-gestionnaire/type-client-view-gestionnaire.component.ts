...
@Component({
  selector: 'app-type-client-view-gestionnaire',
  templateUrl: './type-client-view-gestionnaire.component.html',
  styleUrls: ['./type-client-view-gestionnaire.component.css']
})
export class TypeClientViewGestionnaireComponent implements OnInit {
