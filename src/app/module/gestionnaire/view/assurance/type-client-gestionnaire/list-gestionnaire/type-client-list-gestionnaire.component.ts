...
@Component({
  selector: 'app-type-client-list-gestionnaire',
  templateUrl: './type-client-list-gestionnaire.component.html',
  styleUrls: ['./type-client-list-gestionnaire.component.css']
})
export class TypeClientListGestionnaireComponent implements OnInit {
   // declarations
