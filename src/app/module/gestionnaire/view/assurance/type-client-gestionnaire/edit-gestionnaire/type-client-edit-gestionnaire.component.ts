...
@Component({
  selector: 'app-type-client-edit-gestionnaire',
  templateUrl: './type-client-edit-gestionnaire.component.html',
  styleUrls: ['./type-client-edit-gestionnaire.component.css']
})
export class TypeClientEditGestionnaireComponent implements OnInit {
