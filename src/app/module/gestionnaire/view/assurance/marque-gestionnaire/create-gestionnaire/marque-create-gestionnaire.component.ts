...
@Component({
  selector: 'app-marque-create-gestionnaire',
  templateUrl: './marque-create-gestionnaire.component.html',
  styleUrls: ['./marque-create-gestionnaire.component.css']
})
export class MarqueCreateGestionnaireComponent implements OnInit {
