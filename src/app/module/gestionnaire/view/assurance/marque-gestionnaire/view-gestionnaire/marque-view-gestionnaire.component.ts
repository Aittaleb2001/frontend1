...
@Component({
  selector: 'app-marque-view-gestionnaire',
  templateUrl: './marque-view-gestionnaire.component.html',
  styleUrls: ['./marque-view-gestionnaire.component.css']
})
export class MarqueViewGestionnaireComponent implements OnInit {
