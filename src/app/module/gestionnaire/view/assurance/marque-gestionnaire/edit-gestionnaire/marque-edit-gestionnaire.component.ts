...
@Component({
  selector: 'app-marque-edit-gestionnaire',
  templateUrl: './marque-edit-gestionnaire.component.html',
  styleUrls: ['./marque-edit-gestionnaire.component.css']
})
export class MarqueEditGestionnaireComponent implements OnInit {
