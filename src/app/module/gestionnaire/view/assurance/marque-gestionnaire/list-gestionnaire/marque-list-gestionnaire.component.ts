...
@Component({
  selector: 'app-marque-list-gestionnaire',
  templateUrl: './marque-list-gestionnaire.component.html',
  styleUrls: ['./marque-list-gestionnaire.component.css']
})
export class MarqueListGestionnaireComponent implements OnInit {
   // declarations
