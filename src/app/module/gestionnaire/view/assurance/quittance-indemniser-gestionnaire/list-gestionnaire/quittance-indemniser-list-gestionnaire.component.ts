...
@Component({
  selector: 'app-quittance-indemniser-list-gestionnaire',
  templateUrl: './quittance-indemniser-list-gestionnaire.component.html',
  styleUrls: ['./quittance-indemniser-list-gestionnaire.component.css']
})
export class QuittanceIndemniserListGestionnaireComponent implements OnInit {
   // declarations
