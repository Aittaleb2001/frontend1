...
@Component({
  selector: 'app-quittance-indemniser-view-gestionnaire',
  templateUrl: './quittance-indemniser-view-gestionnaire.component.html',
  styleUrls: ['./quittance-indemniser-view-gestionnaire.component.css']
})
export class QuittanceIndemniserViewGestionnaireComponent implements OnInit {
