...
@Component({
  selector: 'app-quittance-indemniser-create-gestionnaire',
  templateUrl: './quittance-indemniser-create-gestionnaire.component.html',
  styleUrls: ['./quittance-indemniser-create-gestionnaire.component.css']
})
export class QuittanceIndemniserCreateGestionnaireComponent implements OnInit {
