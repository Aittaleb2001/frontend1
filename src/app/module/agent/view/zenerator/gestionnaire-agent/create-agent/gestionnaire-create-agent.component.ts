...
@Component({
  selector: 'app-gestionnaire-create-agent',
  templateUrl: './gestionnaire-create-agent.component.html',
  styleUrls: ['./gestionnaire-create-agent.component.css']
})
export class GestionnaireCreateAgentComponent implements OnInit {
