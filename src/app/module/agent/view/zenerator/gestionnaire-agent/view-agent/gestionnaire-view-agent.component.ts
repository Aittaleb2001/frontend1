...
@Component({
  selector: 'app-gestionnaire-view-agent',
  templateUrl: './gestionnaire-view-agent.component.html',
  styleUrls: ['./gestionnaire-view-agent.component.css']
})
export class GestionnaireViewAgentComponent implements OnInit {
