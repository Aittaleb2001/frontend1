...
@Component({
  selector: 'app-quittance-prime-list-agent',
  templateUrl: './quittance-prime-list-agent.component.html',
  styleUrls: ['./quittance-prime-list-agent.component.css']
})
export class QuittancePrimeListAgentComponent implements OnInit {
   // declarations
