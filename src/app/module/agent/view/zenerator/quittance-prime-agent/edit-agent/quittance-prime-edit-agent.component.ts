...
@Component({
  selector: 'app-quittance-prime-edit-agent',
  templateUrl: './quittance-prime-edit-agent.component.html',
  styleUrls: ['./quittance-prime-edit-agent.component.css']
})
export class QuittancePrimeEditAgentComponent implements OnInit {
