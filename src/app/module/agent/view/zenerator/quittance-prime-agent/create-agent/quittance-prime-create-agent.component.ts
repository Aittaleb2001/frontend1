...
@Component({
  selector: 'app-quittance-prime-create-agent',
  templateUrl: './quittance-prime-create-agent.component.html',
  styleUrls: ['./quittance-prime-create-agent.component.css']
})
export class QuittancePrimeCreateAgentComponent implements OnInit {
