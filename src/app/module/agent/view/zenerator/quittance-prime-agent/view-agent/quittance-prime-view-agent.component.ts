...
@Component({
  selector: 'app-quittance-prime-view-agent',
  templateUrl: './quittance-prime-view-agent.component.html',
  styleUrls: ['./quittance-prime-view-agent.component.css']
})
export class QuittancePrimeViewAgentComponent implements OnInit {
