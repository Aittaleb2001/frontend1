...
@Component({
  selector: 'app-admin-list-agent',
  templateUrl: './admin-list-agent.component.html',
  styleUrls: ['./admin-list-agent.component.css']
})
export class AdminListAgentComponent implements OnInit {
   // declarations
