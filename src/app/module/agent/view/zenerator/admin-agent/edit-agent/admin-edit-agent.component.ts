...
@Component({
  selector: 'app-admin-edit-agent',
  templateUrl: './admin-edit-agent.component.html',
  styleUrls: ['./admin-edit-agent.component.css']
})
export class AdminEditAgentComponent implements OnInit {
