...
@Component({
  selector: 'app-chercheur-view-agent',
  templateUrl: './chercheur-view-agent.component.html',
  styleUrls: ['./chercheur-view-agent.component.css']
})
export class ChercheurViewAgentComponent implements OnInit {
