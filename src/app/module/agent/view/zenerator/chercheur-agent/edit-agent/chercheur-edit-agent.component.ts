...
@Component({
  selector: 'app-chercheur-edit-agent',
  templateUrl: './chercheur-edit-agent.component.html',
  styleUrls: ['./chercheur-edit-agent.component.css']
})
export class ChercheurEditAgentComponent implements OnInit {
