...
@Component({
  selector: 'app-chercheur-list-agent',
  templateUrl: './chercheur-list-agent.component.html',
  styleUrls: ['./chercheur-list-agent.component.css']
})
export class ChercheurListAgentComponent implements OnInit {
   // declarations
