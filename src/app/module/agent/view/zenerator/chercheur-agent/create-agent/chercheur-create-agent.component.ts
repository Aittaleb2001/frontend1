...
@Component({
  selector: 'app-chercheur-create-agent',
  templateUrl: './chercheur-create-agent.component.html',
  styleUrls: ['./chercheur-create-agent.component.css']
})
export class ChercheurCreateAgentComponent implements OnInit {
