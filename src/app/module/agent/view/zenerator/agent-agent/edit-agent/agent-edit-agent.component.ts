...
@Component({
  selector: 'app-agent-edit-agent',
  templateUrl: './agent-edit-agent.component.html',
  styleUrls: ['./agent-edit-agent.component.css']
})
export class AgentEditAgentComponent implements OnInit {
