...
@Component({
  selector: 'app-agent-list-agent',
  templateUrl: './agent-list-agent.component.html',
  styleUrls: ['./agent-list-agent.component.css']
})
export class AgentListAgentComponent implements OnInit {
   // declarations
