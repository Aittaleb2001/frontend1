...
@Component({
  selector: 'app-sinistre-create-agent',
  templateUrl: './sinistre-create-agent.component.html',
  styleUrls: ['./sinistre-create-agent.component.css']
})
export class SinistreCreateAgentComponent implements OnInit {
