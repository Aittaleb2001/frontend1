...
@Component({
  selector: 'app-sinistre-list-agent',
  templateUrl: './sinistre-list-agent.component.html',
  styleUrls: ['./sinistre-list-agent.component.css']
})
export class SinistreListAgentComponent implements OnInit {
   // declarations
