...
@Component({
  selector: 'app-sinistre-edit-agent',
  templateUrl: './sinistre-edit-agent.component.html',
  styleUrls: ['./sinistre-edit-agent.component.css']
})
export class SinistreEditAgentComponent implements OnInit {
