...
@Component({
  selector: 'app-vehicule-view-agent',
  templateUrl: './vehicule-view-agent.component.html',
  styleUrls: ['./vehicule-view-agent.component.css']
})
export class VehiculeViewAgentComponent implements OnInit {
