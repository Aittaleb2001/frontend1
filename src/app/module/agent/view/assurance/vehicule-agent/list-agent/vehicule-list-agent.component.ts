...
@Component({
  selector: 'app-vehicule-list-agent',
  templateUrl: './vehicule-list-agent.component.html',
  styleUrls: ['./vehicule-list-agent.component.css']
})
export class VehiculeListAgentComponent implements OnInit {
   // declarations
