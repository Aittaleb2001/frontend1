...
@Component({
  selector: 'app-vehicule-edit-agent',
  templateUrl: './vehicule-edit-agent.component.html',
  styleUrls: ['./vehicule-edit-agent.component.css']
})
export class VehiculeEditAgentComponent implements OnInit {
