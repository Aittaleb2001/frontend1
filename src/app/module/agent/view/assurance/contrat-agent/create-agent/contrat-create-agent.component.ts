...
@Component({
  selector: 'app-contrat-create-agent',
  templateUrl: './contrat-create-agent.component.html',
  styleUrls: ['./contrat-create-agent.component.css']
})
export class ContratCreateAgentComponent implements OnInit {
