...
@Component({
  selector: 'app-garantie-list-agent',
  templateUrl: './garantie-list-agent.component.html',
  styleUrls: ['./garantie-list-agent.component.css']
})
export class GarantieListAgentComponent implements OnInit {
   // declarations
