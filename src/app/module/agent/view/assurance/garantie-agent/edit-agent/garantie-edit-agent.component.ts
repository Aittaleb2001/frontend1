...
@Component({
  selector: 'app-garantie-edit-agent',
  templateUrl: './garantie-edit-agent.component.html',
  styleUrls: ['./garantie-edit-agent.component.css']
})
export class GarantieEditAgentComponent implements OnInit {
