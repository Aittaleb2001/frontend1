...
@Component({
  selector: 'app-type-client-edit-agent',
  templateUrl: './type-client-edit-agent.component.html',
  styleUrls: ['./type-client-edit-agent.component.css']
})
export class TypeClientEditAgentComponent implements OnInit {
