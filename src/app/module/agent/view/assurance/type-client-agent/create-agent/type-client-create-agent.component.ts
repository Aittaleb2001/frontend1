...
@Component({
  selector: 'app-type-client-create-agent',
  templateUrl: './type-client-create-agent.component.html',
  styleUrls: ['./type-client-create-agent.component.css']
})
export class TypeClientCreateAgentComponent implements OnInit {
