...
@Component({
  selector: 'app-type-client-list-agent',
  templateUrl: './type-client-list-agent.component.html',
  styleUrls: ['./type-client-list-agent.component.css']
})
export class TypeClientListAgentComponent implements OnInit {
   // declarations
