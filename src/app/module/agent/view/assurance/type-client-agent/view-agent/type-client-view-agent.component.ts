...
@Component({
  selector: 'app-type-client-view-agent',
  templateUrl: './type-client-view-agent.component.html',
  styleUrls: ['./type-client-view-agent.component.css']
})
export class TypeClientViewAgentComponent implements OnInit {
