...
@Component({
  selector: 'app-nature-contrat-create-agent',
  templateUrl: './nature-contrat-create-agent.component.html',
  styleUrls: ['./nature-contrat-create-agent.component.css']
})
export class NatureContratCreateAgentComponent implements OnInit {
