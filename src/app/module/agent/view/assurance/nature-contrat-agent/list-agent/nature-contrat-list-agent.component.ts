...
@Component({
  selector: 'app-nature-contrat-list-agent',
  templateUrl: './nature-contrat-list-agent.component.html',
  styleUrls: ['./nature-contrat-list-agent.component.css']
})
export class NatureContratListAgentComponent implements OnInit {
   // declarations
