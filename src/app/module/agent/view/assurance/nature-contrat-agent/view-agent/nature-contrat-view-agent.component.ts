...
@Component({
  selector: 'app-nature-contrat-view-agent',
  templateUrl: './nature-contrat-view-agent.component.html',
  styleUrls: ['./nature-contrat-view-agent.component.css']
})
export class NatureContratViewAgentComponent implements OnInit {
