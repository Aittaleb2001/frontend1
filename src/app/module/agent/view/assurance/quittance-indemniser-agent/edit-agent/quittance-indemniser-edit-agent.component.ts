...
@Component({
  selector: 'app-quittance-indemniser-edit-agent',
  templateUrl: './quittance-indemniser-edit-agent.component.html',
  styleUrls: ['./quittance-indemniser-edit-agent.component.css']
})
export class QuittanceIndemniserEditAgentComponent implements OnInit {
