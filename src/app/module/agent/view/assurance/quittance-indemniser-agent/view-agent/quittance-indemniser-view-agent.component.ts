...
@Component({
  selector: 'app-quittance-indemniser-view-agent',
  templateUrl: './quittance-indemniser-view-agent.component.html',
  styleUrls: ['./quittance-indemniser-view-agent.component.css']
})
export class QuittanceIndemniserViewAgentComponent implements OnInit {
