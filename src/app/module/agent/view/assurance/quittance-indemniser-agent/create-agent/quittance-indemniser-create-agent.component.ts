...
@Component({
  selector: 'app-quittance-indemniser-create-agent',
  templateUrl: './quittance-indemniser-create-agent.component.html',
  styleUrls: ['./quittance-indemniser-create-agent.component.css']
})
export class QuittanceIndemniserCreateAgentComponent implements OnInit {
