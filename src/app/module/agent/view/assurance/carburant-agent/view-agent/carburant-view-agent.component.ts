...
@Component({
  selector: 'app-carburant-view-agent',
  templateUrl: './carburant-view-agent.component.html',
  styleUrls: ['./carburant-view-agent.component.css']
})
export class CarburantViewAgentComponent implements OnInit {
