...
@Component({
  selector: 'app-carburant-create-agent',
  templateUrl: './carburant-create-agent.component.html',
  styleUrls: ['./carburant-create-agent.component.css']
})
export class CarburantCreateAgentComponent implements OnInit {
