...
@Component({
  selector: 'app-carburant-list-agent',
  templateUrl: './carburant-list-agent.component.html',
  styleUrls: ['./carburant-list-agent.component.css']
})
export class CarburantListAgentComponent implements OnInit {
   // declarations
