...
@Component({
  selector: 'app-marque-edit-agent',
  templateUrl: './marque-edit-agent.component.html',
  styleUrls: ['./marque-edit-agent.component.css']
})
export class MarqueEditAgentComponent implements OnInit {
