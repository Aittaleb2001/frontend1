...
@Component({
  selector: 'app-marque-list-agent',
  templateUrl: './marque-list-agent.component.html',
  styleUrls: ['./marque-list-agent.component.css']
})
export class MarqueListAgentComponent implements OnInit {
   // declarations
