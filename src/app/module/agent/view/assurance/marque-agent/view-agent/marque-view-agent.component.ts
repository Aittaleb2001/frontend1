...
@Component({
  selector: 'app-marque-view-agent',
  templateUrl: './marque-view-agent.component.html',
  styleUrls: ['./marque-view-agent.component.css']
})
export class MarqueViewAgentComponent implements OnInit {
