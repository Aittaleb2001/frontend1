...
@Component({
  selector: 'app-type-sinistre-edit-agent',
  templateUrl: './type-sinistre-edit-agent.component.html',
  styleUrls: ['./type-sinistre-edit-agent.component.css']
})
export class TypeSinistreEditAgentComponent implements OnInit {
