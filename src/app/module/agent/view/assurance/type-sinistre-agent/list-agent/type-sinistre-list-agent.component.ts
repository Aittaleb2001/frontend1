...
@Component({
  selector: 'app-type-sinistre-list-agent',
  templateUrl: './type-sinistre-list-agent.component.html',
  styleUrls: ['./type-sinistre-list-agent.component.css']
})
export class TypeSinistreListAgentComponent implements OnInit {
   // declarations
