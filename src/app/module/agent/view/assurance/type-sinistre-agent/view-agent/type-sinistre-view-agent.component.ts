...
@Component({
  selector: 'app-type-sinistre-view-agent',
  templateUrl: './type-sinistre-view-agent.component.html',
  styleUrls: ['./type-sinistre-view-agent.component.css']
})
export class TypeSinistreViewAgentComponent implements OnInit {
