...
@Component({
  selector: 'app-client-sininstre-create-agent',
  templateUrl: './client-sininstre-create-agent.component.html',
  styleUrls: ['./client-sininstre-create-agent.component.css']
})
export class ClientSininstreCreateAgentComponent implements OnInit {
