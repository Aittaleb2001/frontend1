...
@Component({
  selector: 'app-client-sininstre-list-agent',
  templateUrl: './client-sininstre-list-agent.component.html',
  styleUrls: ['./client-sininstre-list-agent.component.css']
})
export class ClientSininstreListAgentComponent implements OnInit {
   // declarations
