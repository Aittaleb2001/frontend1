...
@Component({
  selector: 'app-contrat-garantie-list-agent',
  templateUrl: './contrat-garantie-list-agent.component.html',
  styleUrls: ['./contrat-garantie-list-agent.component.css']
})
export class ContratGarantieListAgentComponent implements OnInit {
   // declarations
