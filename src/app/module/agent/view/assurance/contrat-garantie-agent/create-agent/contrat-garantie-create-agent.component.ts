...
@Component({
  selector: 'app-contrat-garantie-create-agent',
  templateUrl: './contrat-garantie-create-agent.component.html',
  styleUrls: ['./contrat-garantie-create-agent.component.css']
})
export class ContratGarantieCreateAgentComponent implements OnInit {
