...
@Component({
  selector: 'app-type-vehicule-list-agent',
  templateUrl: './type-vehicule-list-agent.component.html',
  styleUrls: ['./type-vehicule-list-agent.component.css']
})
export class TypeVehiculeListAgentComponent implements OnInit {
   // declarations
