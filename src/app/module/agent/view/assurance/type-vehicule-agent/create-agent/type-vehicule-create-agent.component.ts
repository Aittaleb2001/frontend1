...
@Component({
  selector: 'app-type-vehicule-create-agent',
  templateUrl: './type-vehicule-create-agent.component.html',
  styleUrls: ['./type-vehicule-create-agent.component.css']
})
export class TypeVehiculeCreateAgentComponent implements OnInit {
