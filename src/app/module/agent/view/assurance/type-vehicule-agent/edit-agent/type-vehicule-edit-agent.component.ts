...
@Component({
  selector: 'app-type-vehicule-edit-agent',
  templateUrl: './type-vehicule-edit-agent.component.html',
  styleUrls: ['./type-vehicule-edit-agent.component.css']
})
export class TypeVehiculeEditAgentComponent implements OnInit {
