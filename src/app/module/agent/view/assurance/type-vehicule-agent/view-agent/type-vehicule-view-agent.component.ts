...
@Component({
  selector: 'app-type-vehicule-view-agent',
  templateUrl: './type-vehicule-view-agent.component.html',
  styleUrls: ['./type-vehicule-view-agent.component.css']
})
export class TypeVehiculeViewAgentComponent implements OnInit {
