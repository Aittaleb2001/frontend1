...
@Component({
  selector: 'app-devise-edit-agent',
  templateUrl: './devise-edit-agent.component.html',
  styleUrls: ['./devise-edit-agent.component.css']
})
export class DeviseEditAgentComponent implements OnInit {
