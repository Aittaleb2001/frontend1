...
@Component({
  selector: 'app-devise-list-agent',
  templateUrl: './devise-list-agent.component.html',
  styleUrls: ['./devise-list-agent.component.css']
})
export class DeviseListAgentComponent implements OnInit {
   // declarations
