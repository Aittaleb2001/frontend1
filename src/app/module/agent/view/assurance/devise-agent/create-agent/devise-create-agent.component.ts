...
@Component({
  selector: 'app-devise-create-agent',
  templateUrl: './devise-create-agent.component.html',
  styleUrls: ['./devise-create-agent.component.css']
})
export class DeviseCreateAgentComponent implements OnInit {
