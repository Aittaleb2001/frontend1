...
@Component({
  selector: 'app-sinistre-create-admin',
  templateUrl: './sinistre-create-admin.component.html',
  styleUrls: ['./sinistre-create-admin.component.css']
})
export class SinistreCreateAdminComponent implements OnInit {
