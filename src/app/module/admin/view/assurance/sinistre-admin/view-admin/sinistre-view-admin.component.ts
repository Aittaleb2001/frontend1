...
@Component({
  selector: 'app-sinistre-view-admin',
  templateUrl: './sinistre-view-admin.component.html',
  styleUrls: ['./sinistre-view-admin.component.css']
})
export class SinistreViewAdminComponent implements OnInit {
