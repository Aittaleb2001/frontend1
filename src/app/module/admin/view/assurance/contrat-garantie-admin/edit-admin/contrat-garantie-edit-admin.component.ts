...
@Component({
  selector: 'app-contrat-garantie-edit-admin',
  templateUrl: './contrat-garantie-edit-admin.component.html',
  styleUrls: ['./contrat-garantie-edit-admin.component.css']
})
export class ContratGarantieEditAdminComponent implements OnInit {
