...
@Component({
  selector: 'app-contrat-garantie-create-admin',
  templateUrl: './contrat-garantie-create-admin.component.html',
  styleUrls: ['./contrat-garantie-create-admin.component.css']
})
export class ContratGarantieCreateAdminComponent implements OnInit {
