...
@Component({
  selector: 'app-contrat-garantie-view-admin',
  templateUrl: './contrat-garantie-view-admin.component.html',
  styleUrls: ['./contrat-garantie-view-admin.component.css']
})
export class ContratGarantieViewAdminComponent implements OnInit {
