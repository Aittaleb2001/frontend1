...
@Component({
  selector: 'app-contrat-garantie-list-admin',
  templateUrl: './contrat-garantie-list-admin.component.html',
  styleUrls: ['./contrat-garantie-list-admin.component.css']
})
export class ContratGarantieListAdminComponent implements OnInit {
   // declarations
