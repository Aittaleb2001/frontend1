...
@Component({
  selector: 'app-quittance-indemniser-create-admin',
  templateUrl: './quittance-indemniser-create-admin.component.html',
  styleUrls: ['./quittance-indemniser-create-admin.component.css']
})
export class QuittanceIndemniserCreateAdminComponent implements OnInit {
