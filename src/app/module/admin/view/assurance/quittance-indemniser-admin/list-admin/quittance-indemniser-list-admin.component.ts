...
@Component({
  selector: 'app-quittance-indemniser-list-admin',
  templateUrl: './quittance-indemniser-list-admin.component.html',
  styleUrls: ['./quittance-indemniser-list-admin.component.css']
})
export class QuittanceIndemniserListAdminComponent implements OnInit {
   // declarations
