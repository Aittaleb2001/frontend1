...
@Component({
  selector: 'app-quittance-indemniser-edit-admin',
  templateUrl: './quittance-indemniser-edit-admin.component.html',
  styleUrls: ['./quittance-indemniser-edit-admin.component.css']
})
export class QuittanceIndemniserEditAdminComponent implements OnInit {
