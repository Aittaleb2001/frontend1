...
@Component({
  selector: 'app-type-client-list-admin',
  templateUrl: './type-client-list-admin.component.html',
  styleUrls: ['./type-client-list-admin.component.css']
})
export class TypeClientListAdminComponent implements OnInit {
   // declarations
