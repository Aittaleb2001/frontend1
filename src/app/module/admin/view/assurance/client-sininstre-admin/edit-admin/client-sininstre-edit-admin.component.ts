...
@Component({
  selector: 'app-client-sininstre-edit-admin',
  templateUrl: './client-sininstre-edit-admin.component.html',
  styleUrls: ['./client-sininstre-edit-admin.component.css']
})
export class ClientSininstreEditAdminComponent implements OnInit {
