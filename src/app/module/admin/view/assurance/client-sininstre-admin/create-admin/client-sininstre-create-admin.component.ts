...
@Component({
  selector: 'app-client-sininstre-create-admin',
  templateUrl: './client-sininstre-create-admin.component.html',
  styleUrls: ['./client-sininstre-create-admin.component.css']
})
export class ClientSininstreCreateAdminComponent implements OnInit {
