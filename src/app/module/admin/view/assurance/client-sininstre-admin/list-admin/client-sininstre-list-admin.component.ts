...
@Component({
  selector: 'app-client-sininstre-list-admin',
  templateUrl: './client-sininstre-list-admin.component.html',
  styleUrls: ['./client-sininstre-list-admin.component.css']
})
export class ClientSininstreListAdminComponent implements OnInit {
   // declarations
