...
@Component({
  selector: 'app-client-sininstre-view-admin',
  templateUrl: './client-sininstre-view-admin.component.html',
  styleUrls: ['./client-sininstre-view-admin.component.css']
})
export class ClientSininstreViewAdminComponent implements OnInit {
