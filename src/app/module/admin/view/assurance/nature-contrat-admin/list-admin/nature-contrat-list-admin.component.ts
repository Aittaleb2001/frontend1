...
@Component({
  selector: 'app-nature-contrat-list-admin',
  templateUrl: './nature-contrat-list-admin.component.html',
  styleUrls: ['./nature-contrat-list-admin.component.css']
})
export class NatureContratListAdminComponent implements OnInit {
   // declarations
