...
@Component({
  selector: 'app-nature-contrat-create-admin',
  templateUrl: './nature-contrat-create-admin.component.html',
  styleUrls: ['./nature-contrat-create-admin.component.css']
})
export class NatureContratCreateAdminComponent implements OnInit {
