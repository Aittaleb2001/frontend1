...
@Component({
  selector: 'app-nature-contrat-edit-admin',
  templateUrl: './nature-contrat-edit-admin.component.html',
  styleUrls: ['./nature-contrat-edit-admin.component.css']
})
export class NatureContratEditAdminComponent implements OnInit {
