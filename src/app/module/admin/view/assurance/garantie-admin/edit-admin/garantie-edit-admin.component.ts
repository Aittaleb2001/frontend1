...
@Component({
  selector: 'app-garantie-edit-admin',
  templateUrl: './garantie-edit-admin.component.html',
  styleUrls: ['./garantie-edit-admin.component.css']
})
export class GarantieEditAdminComponent implements OnInit {
