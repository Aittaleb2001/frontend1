...
@Component({
  selector: 'app-garantie-create-admin',
  templateUrl: './garantie-create-admin.component.html',
  styleUrls: ['./garantie-create-admin.component.css']
})
export class GarantieCreateAdminComponent implements OnInit {
