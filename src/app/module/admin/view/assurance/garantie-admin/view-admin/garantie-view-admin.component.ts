...
@Component({
  selector: 'app-garantie-view-admin',
  templateUrl: './garantie-view-admin.component.html',
  styleUrls: ['./garantie-view-admin.component.css']
})
export class GarantieViewAdminComponent implements OnInit {
