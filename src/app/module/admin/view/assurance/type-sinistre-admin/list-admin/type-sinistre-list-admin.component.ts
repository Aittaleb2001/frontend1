...
@Component({
  selector: 'app-type-sinistre-list-admin',
  templateUrl: './type-sinistre-list-admin.component.html',
  styleUrls: ['./type-sinistre-list-admin.component.css']
})
export class TypeSinistreListAdminComponent implements OnInit {
   // declarations
