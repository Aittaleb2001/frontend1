...
@Component({
  selector: 'app-type-sinistre-create-admin',
  templateUrl: './type-sinistre-create-admin.component.html',
  styleUrls: ['./type-sinistre-create-admin.component.css']
})
export class TypeSinistreCreateAdminComponent implements OnInit {
