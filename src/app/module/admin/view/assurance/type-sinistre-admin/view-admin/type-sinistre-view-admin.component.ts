...
@Component({
  selector: 'app-type-sinistre-view-admin',
  templateUrl: './type-sinistre-view-admin.component.html',
  styleUrls: ['./type-sinistre-view-admin.component.css']
})
export class TypeSinistreViewAdminComponent implements OnInit {
