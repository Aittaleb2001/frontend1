...
@Component({
  selector: 'app-devise-view-admin',
  templateUrl: './devise-view-admin.component.html',
  styleUrls: ['./devise-view-admin.component.css']
})
export class DeviseViewAdminComponent implements OnInit {
