...
@Component({
  selector: 'app-carburant-edit-admin',
  templateUrl: './carburant-edit-admin.component.html',
  styleUrls: ['./carburant-edit-admin.component.css']
})
export class CarburantEditAdminComponent implements OnInit {
