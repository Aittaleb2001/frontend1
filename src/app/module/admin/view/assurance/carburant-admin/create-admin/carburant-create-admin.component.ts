...
@Component({
  selector: 'app-carburant-create-admin',
  templateUrl: './carburant-create-admin.component.html',
  styleUrls: ['./carburant-create-admin.component.css']
})
export class CarburantCreateAdminComponent implements OnInit {
