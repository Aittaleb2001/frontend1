...
@Component({
  selector: 'app-type-vehicule-list-admin',
  templateUrl: './type-vehicule-list-admin.component.html',
  styleUrls: ['./type-vehicule-list-admin.component.css']
})
export class TypeVehiculeListAdminComponent implements OnInit {
   // declarations
