...
@Component({
  selector: 'app-type-vehicule-edit-admin',
  templateUrl: './type-vehicule-edit-admin.component.html',
  styleUrls: ['./type-vehicule-edit-admin.component.css']
})
export class TypeVehiculeEditAdminComponent implements OnInit {
