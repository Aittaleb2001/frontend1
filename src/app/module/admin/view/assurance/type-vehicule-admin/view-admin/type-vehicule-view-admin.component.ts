...
@Component({
  selector: 'app-type-vehicule-view-admin',
  templateUrl: './type-vehicule-view-admin.component.html',
  styleUrls: ['./type-vehicule-view-admin.component.css']
})
export class TypeVehiculeViewAdminComponent implements OnInit {
