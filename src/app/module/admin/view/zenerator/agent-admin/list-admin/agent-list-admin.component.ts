...
@Component({
  selector: 'app-agent-list-admin',
  templateUrl: './agent-list-admin.component.html',
  styleUrls: ['./agent-list-admin.component.css']
})
export class AgentListAdminComponent implements OnInit {
   // declarations
