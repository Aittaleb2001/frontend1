...
@Component({
  selector: 'app-agent-edit-admin',
  templateUrl: './agent-edit-admin.component.html',
  styleUrls: ['./agent-edit-admin.component.css']
})
export class AgentEditAdminComponent implements OnInit {
