...
@Component({
  selector: 'app-quittance-prime-view-admin',
  templateUrl: './quittance-prime-view-admin.component.html',
  styleUrls: ['./quittance-prime-view-admin.component.css']
})
export class QuittancePrimeViewAdminComponent implements OnInit {
