...
@Component({
  selector: 'app-quittance-prime-create-admin',
  templateUrl: './quittance-prime-create-admin.component.html',
  styleUrls: ['./quittance-prime-create-admin.component.css']
})
export class QuittancePrimeCreateAdminComponent implements OnInit {
