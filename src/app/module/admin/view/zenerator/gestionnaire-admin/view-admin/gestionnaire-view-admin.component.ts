...
@Component({
  selector: 'app-gestionnaire-view-admin',
  templateUrl: './gestionnaire-view-admin.component.html',
  styleUrls: ['./gestionnaire-view-admin.component.css']
})
export class GestionnaireViewAdminComponent implements OnInit {
