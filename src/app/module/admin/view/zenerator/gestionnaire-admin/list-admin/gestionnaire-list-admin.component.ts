...
@Component({
  selector: 'app-gestionnaire-list-admin',
  templateUrl: './gestionnaire-list-admin.component.html',
  styleUrls: ['./gestionnaire-list-admin.component.css']
})
export class GestionnaireListAdminComponent implements OnInit {
   // declarations
