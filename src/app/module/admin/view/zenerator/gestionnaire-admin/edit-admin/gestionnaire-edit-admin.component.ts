...
@Component({
  selector: 'app-gestionnaire-edit-admin',
  templateUrl: './gestionnaire-edit-admin.component.html',
  styleUrls: ['./gestionnaire-edit-admin.component.css']
})
export class GestionnaireEditAdminComponent implements OnInit {
